...
export const PromptDisplay = memo(function PromptDisplay({ prompt }: Props) {
  ...
  return (
    <Card className="border-primary/20">
      <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 bg-primary/5 rounded-t-lg">
        ...
        <Button
          ...
          onClick={handleCopy}
          className="gap-2"
          aria-label="Copy vibe coding prompt to clipboard"
        >
      ...
      <CardContent className="pt-6">
        <div className="bg-muted rounded-lg p-4 font-mono text-sm whitespace-pre-wrap break-words leading-relaxed">
          {prompt}
        </div>
